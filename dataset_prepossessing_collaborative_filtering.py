...
userIds_moviesIds_ratings = csr_matrix((ratings_df["ratings"].values,
                                        (ratings_df["ratings"], ratings_df["ratings"])),
                                       shape=(uniq_user_ids, uniq_movie_ids))

moviesIds_userIds_ratings = csr_matrix((ratings_df["ratings"],
                                        (ratings_df["ratings"], ratings_df["ratings"])),
                                       shape=(uniq_movie_ids, uniq_user_ids))
